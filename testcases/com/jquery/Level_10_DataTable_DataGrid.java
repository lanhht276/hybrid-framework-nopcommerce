...
public class Level_10_DataTable_DataGrid extends BaseTest {
	...
	public void Table_04_Action_At_Any_Row() {
		...
		homePage.enterToTextBoxByColumnNameAtRowNumber("Company", "1", "Germany company");

		homePage.enterToTextBoxByColumnNameAtRowNumber("Contact Person", "1", "LanhHT");

		homePage.enterToTextBoxByColumnNameAtRowNumber("Order Placed", "1", "1000");

		homePage.enterToCalendarByColumnNameAtRowNumber("Member Since", "1", "2000-06-20");
		...
		homePage.sleepInSecond(1);
		homePage.enterToCalendarByColumnNameAtRowNumber("Member Since", "2", "2023-06-28");
	...
	public void Table_05_Demo_Register_And_Check_AdminPage() {
		...
		// homePage.sendKeyToFieldInAccountPage("Email Address", "afc" +
		// getRandomNumber() + "@mail.com" );
