...
public class Level_06_Page_Generator_Manager_I extends BaseTest {
	...
	private String firstName, lastName, invalidEmail, existingEmail, notFoundEmail, password, confirmPassword,
			invalidPassword;
	...
	public void Login_03_Email_Not_Register() {
		...
		Assert.assertEquals(loginPage.getInvalidErrorMessage(),
